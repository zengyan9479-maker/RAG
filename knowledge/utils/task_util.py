...
_NODE_NAME_TO_CN: Dict[str, str] = {
    "upload_file": "上传文件",
    "entry_node": "检查文件",
    "word_to_pdf_node": "Word转PDF",
    "pdf_to_md_node": "PDF转Markdown",
    "md_image_node": "Markdown图片处理",
    "document_split_node": "文档切分",
    "formula_semantic_node": "公式语义解析",
    "document_identity_node": "建立文档档案",
    "document_registry_node": "写入文档注册表",
    "bge_embedding_chunks_node": "向量生成",
    "milvus_import_node": "导入向量数据库",
    "__end__": "处理完成",
    # --- Query 流程节点（kb/query_process/main_graph.py）---
    "document_route_node": "识别文档范围",
    "query_type_node": "识别查询类型",
    "image_query_node": "解析查询图片",
    "answer_output_node": "生成答案",
    "rerank_node": "重排序",
    "context_expansion_node": "扩展章节上下文",
    "rrf_merge_node": "加权RRF融合",
    "bm25_search_node": "BM25关键词检索",
    "conflict_judge_node": "LLM冲突仲裁",
